...
REPLACE INTO `tbl_language_labels` (`label_key`, `label_lang_id`, `label_caption`) VALUES ('LBL_PHONE_NO_VALIDATION_MSG', '1', 'Please add vaild phone no and length between 4 to 16');
