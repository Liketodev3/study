...
Fixes:
    ...
    * #040842 - Sale commission at admin section is not working properly in case>> when user purchase any lesson with discount coupon.
...
. #038302 - " check earnings, sales report why is it showing so many transactions. If we click on proceed for payment, even if we Don’t pay it sends a message to teacher and adds new sales. It should be once payment is done successfully
