<div class="box -padding-20">
    <a href="<?php echo CommonHelper::generateUrl('TeacherLessonsPlan'); ?>" class="btn btn--secondary left" ><?php echo Label::getLabel('LBL_Add_New_Lesson_Plan') ?></a>
        ...
        <table class="table">
            <tbody><tr class="-hide-mobile">
                ...
                foreach ($lessonsPlanData as $lessonPlanData) {
                    ?>
                    <tr>
                        <td><span class="td__data"><?php echo $i++; ?></span></td>
                        <td><span class="td__data"><?php echo $lessonPlanData['tlpn_title']; ?></span></td>
                        <td><?php
                        ...
                        <td><span class="td__data"><?php echo $statusArr[$lessonPlanData['tlpn_level']]; ?></span></td>
                        <td><a href="javascript:void(0);" class="btn btn--secondary" onclick="assignLessonPlanToLessons('<?php echo $lessonId; ?>', '<?php echo $lessonPlanData['tlpn_id']; ?>')"><?php echo Label::getLabel('LBL_Assign'); ?></a></td>
                    </tr>
                <?php } ?>
            </tbody>
        </table>
