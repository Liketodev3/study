	...
	<div class="row">
		<div class="col-lg-4 -align-center order-md-2">
			...
			<div class="google__Sync">
				...
				<a href="<?php echo CommonHelper::generateUrl('Account', 'GoogleCalendarAuthorize') ?>"><img src="<?php echo CONF_WEBROOT_FRONT_URL; ?>images/btn_google_signin_dark_normal_web.png" /></a>
			</div>
			<span class="-gap"></span>
