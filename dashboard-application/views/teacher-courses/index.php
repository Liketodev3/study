		   ...
		   <div class="page-panel__right">
				 ...
				 <div class="page-head">
				   <div class="d-flex justify-content-between align-items-center">
						 <div><h1><?php echo Label::getLabel('LBL_Teacher_Courses'); ?></h1></div>
						 <div><a class="btn btn--secondary btn--small" href="javascript:void(0);" onclick="add(0);" >Add New Course</a></div>
				 ...
				 <div class="page-filters">
					   <form onsubmit="searchCourses(this); return false;"  class="form form--small">
							<div class="row">
