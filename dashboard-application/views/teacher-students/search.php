					...
					foreach ($students as $student) { ?>
						<tr>
							...
							<td>
								...
								<?php $durations = explode(',', $student['lessonDuration']);
							...
							<td>
								...
								<span class="td__data">
									...
									<a href="javascript:void(0)" onClick="generateThread(<?php echo $student['learnerId']; ?>)" class="btn btn--small btn--secondary"><?php echo Label::getLabel('LBL_Message'); ?></a>
								</span>
							</td>
						</tr>
					<?php } ?>
