                    ...
                    <div class="box-group">
                        ...
                        <div class="box -padding-20 box--earning" style="margin-bottom: 30px;">
							...
							<div class="row justify-content-between align-items-center">
								<div class="col-12 "><h6><?php echo Label::getLabel('LBL_Earnings'); ?></h6></div>
								<div class="col-12">
                                    ...
                                    <li>
                                        <a href="javascript:void(0)">
                                            <figure class="avtar avtar--small" data-text="A">
                                                <img src="<?php echo CommonHelper::generateUrl('image','user',array($studentId), CONF_WEBROOT_FRONT_URL) ?>" alt="">
                                            </figure>
                                        </a>
                                    </li>
								<?php }?>
