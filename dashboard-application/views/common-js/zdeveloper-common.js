...
(function($){
	...
	setSiteDefaultLang = function( langId ){
		fcom.ajax(fcom.makeUrl('Home','setSiteDefaultLang', [langId], confFrontEndUrl),'',function(res){
			document.location.reload();
		});
	},

	setSiteDefaultCurrency = function( currencyId ){
		fcom.ajax(fcom.makeUrl('Home','setSiteDefaultCurrency', [currencyId], confFrontEndUrl), '', function(res){
			document.location.reload();
		});
	},
