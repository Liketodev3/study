                        ...
                        <div class="box -align-center" style="margin-bottom: 30px;">
                            <div class="-padding-20">
								<div class="avtar avtar--centered" data-text="<?php echo CommonHelper::getFirstChar($userDetails['user_first_name']); ?>">
									...
									if( true == User::isProfilePicUploaded( $userDetails['user_id'] ) ){
										$img = CommonHelper::generateUrl('Image','user', array( $userDetails['user_id'] ), CONF_WEBROOT_FRONT_URL).'?'.time();
                                ...
                                <span class="-gap"></span>
                                <h3 class="-display-inline"><h3 class="-display-inline"><?php echo $userDetails['user_first_name']; ?></h3></h3>
                            ...
                            <div class="tabled">
                                <div class="tabled__cell">
                                    <h3 class="-color-secondary"><?php echo $userDetails['learnerSchLessons']; ?></h3> <?php echo Label::getLabel('LBL_Scheduled'); ?>
                                </div>
                                <div class="tabled__cell">
										...
										<li>
											<a href="javascript:void(0)">
												<figure class="avtar avtar--small" data-text="A">
													<img src="<?php echo CommonHelper::generateUrl('image','user',array($teacherId), CONF_WEBROOT_FRONT_URL) ?>" alt="">
												</figure>
											</a>
										</li>
									<?php }?>
