            ...
            <div class="col-xl-4 col-lg-4 col-sm-12">
                <div class="session-infobar__action">
                    ...
                    <?php if ($lessonData['sldetail_learner_status'] != ScheduledLesson::STATUS_CANCELLED) { ?>
                        ...
                        <?php
                        if (
                                ($lessonData['sldetail_learner_status'] == ScheduledLesson::STATUS_COMPLETED ||
                                ($lessonData['sldetail_learner_status'] == ScheduledLesson::STATUS_SCHEDULED &&
                                $currentUnixTime > $endDateTimeUnixtime && $lessonData['slesson_teacher_join_time'] == 0)) &&
                                ($lessonData['issrep_id'] < 1 || $lessonData['slesson_has_issue'] == applicationConstants::NO)
                        ) {
                            ?>
