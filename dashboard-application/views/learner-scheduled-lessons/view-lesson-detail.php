        ...
        <div class="row justify-content-between align-items-center">
            ...
            <div class="session-infobar__action">
                    ...
                    <?php if ($lesson['sldetail_learner_status'] != ScheduledLesson::STATUS_CANCELLED) { ?>
                        <?php if ($lesson['slesson_grpcls_id'] <= 0 && $lesson['slesson_status'] == ScheduledLesson::STATUS_SCHEDULED && $currentUnixTime < $startDateTimeUnixtime) { ?>
...
<script>
    ...
    var lesson_completed = '<?php echo $lesson['sldetail_learner_end_time'] > 0 ?>';
