...
<div class="box">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-8 col-lg-8 col-sm-8">
                                <p><strong>
                                        ...
                                        ?> </strong> 
                                    <?php
                                    echo '<strong>' . Label::getLabel('LBL_Comment_:') . '</strong> ' . nl2br($_issue['issrep_resolve_comments']);
    ...
    <?php
    if ($lastIssue['issrep_issues_resolve_type'] != IssuesReported::RESOLVE_TYPE_LESSON_COMPLETED_FULL_REFUND) {
...
<?php if (!empty($lastIssue['issrep_updated_by_admin']) && !empty($lastIssue['issrep_admin_comments'])) { ?>
    <div class="box">
        <div class="box__head">
            <h6><?php echo Label::getLabel('LBL_Support_Resolution'); ?></h6>
        </div>
        <div class="box__body -padding-20">
            <div class="content-repeated-container">
