...
class AuthorizeAimPayController extends PaymentController
{
    ...
    {
        $frm = new Form('frmPaymentForm', array('id' => 'frmPaymentForm', 'action' => CommonHelper::generateUrl('AuthorizeAimPay', 'send', array($orderId), '', null, false, false), 'class' => "form form--normal"));
