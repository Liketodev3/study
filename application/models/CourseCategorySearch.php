...
class CourseCategorySearch extends SearchBase
{
    public function __construct($langId = 0)
    {
        ...
        if ($langId > 0) {
            ...
            $this->joinTable(CourseCategory::DB_TBL_LANG, 'LEFT OUTER JOIN', 'cc_l.'.CourseCategory::DB_LANG_TBL_PREFIX.'ccategory_id = cc.ccategory_id AND cc_l.'. CourseCategory::DB_LANG_TBL_PREFIX .'lang_id = '. $langId, 'cc_l');
        }
    }
}
