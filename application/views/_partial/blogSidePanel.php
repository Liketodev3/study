...
<div class="col-xl-3 col-lg-4 order-xl-2 order-lg-2">
   ...
   <div class="box box--cta box--cta-blog -padding-30 -border -align-center">
      ...
      <a href="<?php echo CommonHelper::generateUrl('Blog','contributionForm'); ?>" class="btn btn--secondary btn--block btn--large"><span class="svg-icon"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
