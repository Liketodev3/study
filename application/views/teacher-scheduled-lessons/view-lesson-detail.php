	...
	<div class="screen">
        <div class="screen__left" style="background-image:url(<?php echo CONF_WEBROOT_URL ?>images/2000x900_1.jpg">
            <div class="screen__center-content">
                ...
                <a href="javascript:void(0);" <?php echo ($startTime>$curDate || !$isScheduled ? 'style="display:none;"' : '') ?> class="btn btn--secondary btn--xlarge join_lesson_now" id="joinL" onclick="joinLesson(CometJsonData,CometJsonFriendData);"><?php echo Label::getLabel('LBL_Join_Lesson'); ?></a>
...
$(function(){
    ...
    if(is_time_up == '1' && canEnd && !lesson_completed){
        endLessonConfirm();
    }
