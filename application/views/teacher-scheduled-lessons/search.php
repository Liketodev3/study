		...
		<?php if($lesson['order_is_paid'] != Order::ORDER_IS_CANCELLED) { ?>
			<div class="col-xl-4 col-lg-4 col-md-12 col-positioned">
				...
				<ul class="actions">
					...
					<?php if($lesson['slesson_status'] == ScheduledLesson::STATUS_NEED_SCHEDULING || $lesson['slesson_status'] == ScheduledLesson::STATUS_SCHEDULED) { ?>
						<li>
					...
					<?php } ?>
					<?php if( $lesson['slesson_status'] == ScheduledLesson::STATUS_ISSUE_REPORTED && $lesson['issrep_status'] == 0) { ?>
						<li>
							<a href="javascript:void(0);"  onclick="resolveIssue('<?php echo $lesson['issrep_id']; ?>','<?php echo $lesson['slesson_id']; ?>')" class="" title="<?php echo Label::getLabel('LBL_Resolve_Issue'); ?>">
