...
?><br />
	<p class="text-right">
		<span class="-display-inline"><?php echo Label::getLabel('LBL_Not_Happy_with_teacher_solution?'); ?> &nbsp; </span><a href="javascript:void(0);" class="btn btn--secondary -display-inline" onclick="return confirm('<?php echo Label::getLabel('LBL_Are_you_sure_want_to_report_the_issue_To_support_team'); ?>')?reportIssueToAdmin('<?php echo $issueDeatils['issrep_id'];?>', '<?php echo $issueDeatils['issrep_slesson_id']; ?>'):'';"><?php echo Label::getLabel('LBL_Report_Issue_to_Support_Team'); ?></a>
	</p>
<?php } ?>
