...
<?php if(!empty($data)){?>
    ...
    <div class="content-repeated-container">
        ...
        <?php if($data['tlpn_tags']) {
            $tags = explode(',',$data['tlpn_tags']);
            ?>
        <div class="content-repeated">
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-sm-4">
                    <p class="-small-title"><strong><?php echo Label::getLabel('LBL_Tags'); ?></strong></p>
                </div>
                <div class="col-xl-8 col-lg-8 col-sm-8">
                   <ul class="tags-inline">
                   <?php foreach($tags as $tag){ ?>
                        <li><a><span><?php echo  $tag; ?></span></a></li>
                   <?php }?>
                    </ul>
                </div>
            </div>
