      ...
      <div class="screen__left" style="background-image:url(/images/2000x900_1.jpg">
         <div class="screen__center-content">
            ...
            <div class="alert alert--info" role="alert">
               ...
               <p><?php echo Label::getLabel('LBL_Note'); ?>:<?php echo Label::getLabel('LBL_This_lesson_is_Unscheduled._schedule_it.'); ?> </p>
            </div>
            <span class="-gap"></span>
            <?php } ?>
            ...
            <div class="alert alert--info" role="alert">
               <p><?php echo Label::getLabel('LBL_Note'); ?>:<?php echo Label::getLabel('LBL_This_lesson_is_completed._rate_it.'); ?> </p>
            </div>
            <span class="-gap"></span>
            <a href="javascript:void(0);" onclick="lessonFeedback('<?php echo $lessonData['slesson_id'];  ?>');" class="btn btn--primary btn--large"><?php echo Label::getLabel('LBL_Rate_it.'); ?></a>               
            <?php } ?>
			
			<?php if( $countReviews > 0 ) { ?>
            <div class="alert alert--info" role="alert">
               <a class="close" href="javascript:void(0)"></a>
               <p><?php echo Label::getLabel('LBL_Note'); ?>:<?php echo Label::getLabel('LBL_This_lesson_is_completed.'); ?> </p>
            </div>
            <span class="-gap"></span>
            <?php } ?>
            ...
            <div class="alert alert--info" role="alert">
               <a class="close" href="javascript:void(0)"></a>
               <p><?php echo Label::getLabel('LBL_Note'); ?>:<?php echo Label::getLabel('LBL_This_lesson_is_completed_And_Issue_Is_Reported_Successfully!'); ?> </p>
            </div>
            <span class="-gap"></span>
            <?php } */ ?>
            ...
            <a href="javascript:void(0);" style="display:none;" class="btn btn--secondary btn--xlarge join_lesson_now" id="joinL" onclick="checkUSerExistInCometChatApi('<?php echo $chatId; ?>','<?php echo $lessonData['teacherId']; ?>');"><?php echo Label::getLabel('LBL_Join_Lesson'); ?></a>
            <?php if( $lessonData['slesson_status'] != ScheduledLesson::STATUS_SCHEDULED ) { ?>            
			        <a href="<?php echo CommonHelper::generateUrl('learner'); ?>" class="btn btn--secondary btn--large"><?php echo Label::getLabel('LBL_Go_to_Dashboard.'); ?></a>
            <?php } ?>                        
            <div class="timer">
      ...
      <div class="screen__right">
         <div class="tab-horizontal tabs-js">
            <ul>
               ...
               <li><a href="#tab2"><?php echo Label::getLabel('LBL_Flashcards'); ?></a></li>
            </ul>
         </div>
                  ...
                  <div class="box-head">
                     <div class="page-head">
                        <div class="d-flex justify-content-between align-items-center">
                           ...
                           <div>
                              <a class="btn btn--secondary btn--small" href="javascript:void(0)" onclick="flashCardForm(<?php echo $lessonData['slesson_id'] ?>, 0, <?php echo $lessonData['learnerId'] ?>, <?php echo $lessonData['teacherId'] ?>)"><?php echo Label::getLabel('LBL_Add_New'); ?></a>
                           </div>
                        </div>
                     </div>
