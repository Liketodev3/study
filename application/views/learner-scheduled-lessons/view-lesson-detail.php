        ...
        <div class="screen__left" style="background-image:url(<?php echo CONF_WEBROOT_URL ?>images/2000x900_1.jpg">
            <div class="screen__center-content">
                ...
                <div class="join-btns join_lesson_now" id="joinL" <?php echo ($startTime > $curDate || $curDate > $endTime || !$isScheduled ? 'style="display:none;"' : '') ?>>
                    ...
                    <a href="javascript:void(0);" class="btn btn--primary btn--xlarge -hide-mobile" onclick="joinLesson('<?php echo $chatId; ?>','<?php echo $lessonData['teacherId']; ?>');"><?php echo Label::getLabel('LBL_Join_Lesson_From_Browser'); ?></a>
                ...
                <?php if ($lessonData['sldetail_learner_status'] == ScheduledLesson::STATUS_COMPLETED &&  $lessonData['issrep_id'] < 1) { ?>
                                ...
                                <div id="lesson_actions">
                                    ...
                                    <ul class="actions justify-content-start">
                                        ...
                                        <?php if ($lessonData['sldetail_learner_status'] != ScheduledLesson::STATUS_CANCELLED) { ?>
                                            <?php if ($lessonData['sldetail_learner_status'] == ScheduledLesson::STATUS_NEED_SCHEDULING) {
                                                ...
                                                <li>
                                                    <a href="javascript:void(0);" onclick="viewBookingCalendar('<?php echo $lessonData['sldetail_id']; ?>','<?php echo $is_trail; ?>')" class="" title="<?php echo Label::getLabel('LBL_Schedule_Lesson'); ?>">
                                                        <svg id="Layer_1_1_" enable-background="new 0 0 64 64" width="30px" viewBox="0 0 64 64" width="512" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="m56 40.10529v-28.10529c0-2.75684-2.24316-5-5-5h-2v-2c0-1.6543-1.3457-3-3-3s-3 1.3457-3 3v2h-5v-2c0-1.6543-1.3457-3-3-3s-3 1.3457-3 3v2h-6v-2c0-1.6543-1.3457-3-3-3s-3 1.3457-3 3v2h-5v-2c0-1.6543-1.3457-3-3-3s-3 1.3457-3 3v2h-2c-2.75684 0-5 2.24316-5 5v40c0 2.75684 2.24316 5 5 5h33.62347c2.07868 3.58081 5.94617 6 10.37653 6 6.61719 0 12-5.38281 12-12 0-4.83142-2.87561-8.99408-7-10.89471zm-11-35.10529c0-.55176.44824-1 1-1s1 .44824 1 1v6c0 .55176-.44824 1-1 1s-1-.44824-1-1zm-11 0c0-.55176.44824-1 1-1s1 .44824 1 1v6c0 .55176-.44824 1-1 1s-1-.44824-1-1zm-12 0c0-.55176.44824-1 1-1s1 .44824 1 1v6c0 .55176-.44824 1-1 1s-1-.44824-1-1zm-11 0c0-.55176.44824-1 1-1s1 .44824 1 1v6c0 .55176-.44824 1-1 1s-1-.44824-1-1zm-4 4h2v2c0 1.6543 1.3457 3 3 3s3-1.3457 3-3v-2h5v2c0 1.6543 1.3457 3 3 3s3-1.3457 3-3v-2h6v2c0 1.6543 1.3457 3 3 3s3-1.3457 3-3v-2h5v2c0 1.6543 1.3457 3 3 3s3-1.3457 3-3v-2h2c1.6543 0 3 1.3457 3 3v5h-50v-5c0-1.6543 1.3457-3 3-3zm0 46c-1.6543 0-3-1.3457-3-3v-33h50v20.39484c-.96082-.24866-1.96246-.39484-3-.39484-.6828 0-1.34808.07056-2 .1806v-5.1806c0-.55273-.44727-1-1-1h-6c-.55273 0-1 .44727-1 1v6c0 .55273.44727 1 1 1h2.38086c-3.23914 2.15106-5.38086 5.82843-5.38086 10 0 1.40411.25494 2.74664.70001 4zm40-16h-4v-4h4zm4 22c-5.51367 0-10-4.48633-10-10s4.48633-10 10-10 10 4.48633 10 10-4.48633 10-10 10z" />
                                                            <path d="m52 49.2774v-6.2774h-2v6.2774c-.59528.34644-1 .98413-1 1.7226 0 .10126.01526.19836.02979.29553l-3.65479 2.92322 1.25 1.5625 3.65161-2.92133c.22492.08759.46753.14008.72339.14008 1.10455 0 2-.89545 2-2 0-.73846-.40472-1.37616-1-1.7226z" />
                                                            <path d="m15 22h-6c-.55273 0-1 .44727-1 1v6c0 .55273.44727 1 1 1h6c.55273 0 1-.44727 1-1v-6c0-.55273-.44727-1-1-1zm-1 6h-4v-4h4z" />
                                                            <path d="m26 22h-6c-.55273 0-1 .44727-1 1v6c0 .55273.44727 1 1 1h6c.55273 0 1-.44727 1-1v-6c0-.55273-.44727-1-1-1zm-1 6h-4v-4h4z" />
                                                            <path d="m37 22h-6c-.55273 0-1 .44727-1 1v6c0 .55273.44727 1 1 1h6c.55273 0 1-.44727 1-1v-6c0-.55273-.44727-1-1-1zm-1 6h-4v-4h4z" />
                                                            <path d="m42 30h6c.55273 0 1-.44727 1-1v-6c0-.55273-.44727-1-1-1h-6c-.55273 0-1 .44727-1 1v6c0 .55273.44727 1 1 1zm1-6h4v4h-4z" />
                                                            <path d="m15 33h-6c-.55273 0-1 .44727-1 1v6c0 .55273.44727 1 1 1h6c.55273 0 1-.44727 1-1v-6c0-.55273-.44727-1-1-1zm-1 6h-4v-4h4z" />
                                                            <path d="m26 33h-6c-.55273 0-1 .44727-1 1v6c0 .55273.44727 1 1 1h6c.55273 0 1-.44727 1-1v-6c0-.55273-.44727-1-1-1zm-1 6h-4v-4h4z" />
                                                            <path d="m37 33h-6c-.55273 0-1 .44727-1 1v6c0 .55273.44727 1 1 1h6c.55273 0 1-.44727 1-1v-6c0-.55273-.44727-1-1-1zm-1 6h-4v-4h4z" />
                                                            <path d="m15 44h-6c-.55273 0-1 .44727-1 1v6c0 .55273.44727 1 1 1h6c.55273 0 1-.44727 1-1v-6c0-.55273-.44727-1-1-1zm-1 6h-4v-4h4z" />
                                                            <path d="m26 44h-6c-.55273 0-1 .44727-1 1v6c0 .55273.44727 1 1 1h6c.55273 0 1-.44727 1-1v-6c0-.55273-.44727-1-1-1zm-1 6h-4v-4h4z" />
                                                            <path d="m37 44h-6c-.55273 0-1 .44727-1 1v6c0 .55273.44727 1 1 1h6c.55273 0 1-.44727 1-1v-6c0-.55273-.44727-1-1-1zm-1 6h-4v-4h4z" /></svg>
                                                    </a>
                                                </li>
                                            <?php } ?>
                                            <?php if (($lessonData['sldetail_learner_status'] == ScheduledLesson::STATUS_COMPLETED || ($lessonData['sldetail_learner_status'] == ScheduledLesson::STATUS_SCHEDULED && $curDate > $endTime && $lessonData['slesson_teacher_join_time'] == 0)) && ($lessonData['issrep_id'] < 1 || $lessonData['issrep_status'] == IssuesReported::STATUS_RESOLVED && ($lessonData['issrep_issues_resolve_by'] != 3 && $lessonData['issrep_issues_resolve_by'] != 4))) { ?>
                                                <li>
                                                    <a href="javascript:void(0);" onclick="issueReported('<?php echo $lessonData['sldetail_id']; ?>')" class="" title="<?php echo Label::getLabel('LBL_Issue_Reported'); ?>">
                                                        <svg width="20px" viewBox="0 0 60 60" width="512" xmlns="http://www.w3.org/2000/svg">
                                                            <g id="Page-1" fill="none" fill-rule="evenodd">
                                                                <g id="070---Laptop-Message-Not-Sent" fill="rgb(0,0,0)" fill-rule="nonzero">
                                                                    <path id="Shape" d="m58 48h-2v-33c-.0033061-2.7600532-2.2399468-4.9966939-5-5h-1v-7c0-1.65685425-1.3431458-3-3-3h-34c-1.6568542 0-3 1.34314575-3 3v7h-1c-2.76005315.0033061-4.99669388 2.2399468-5 5v33h-2c-1.1045695 0-2 .8954305-2 2v3c.00495836 3.8639376 3.13606244 6.9950416 7 7h46c3.8639376-.0049584 6.9950416-3.1360624 7-7v-3c0-1.1045695-.8954305-2-2-2zm-46-45c0-.55228475.4477153-1 1-1h34c.5522847 0 1 .44771525 1 1v28c0 .5522847-.4477153 1-1 1h-24c-.5522847 0-1 .4477153-1 1s.4477153 1 1 1h.8l-5.8 4.01v-4.01h1c.5522847 0 1-.4477153 1-1s-.4477153-1-1-1h-6c-.5522847 0-1-.4477153-1-1zm-6 12c0-1.6568542 1.34314575-3 3-3h1v19c0 1.6568542 1.3431458 3 3 3h3v4.01c.0055034 1.1006623.899324 1.9900138 2 1.99.4068132-.0004921.803803-.1250311 1.138-.357l8.174-5.643h19.688c1.6568542 0 3-1.3431458 3-3v-19h1c1.6568542 0 3 1.3431458 3 3v33h-48zm15 35h18v1c0 1.1045695-.8954305 2-2 2h-14c-1.1045695 0-2-.8954305-2-2zm37 3c-.0033061 2.7600532-2.2399468 4.9966939-5 5h-46c-2.76005315-.0033061-4.99669388-2.2399468-5-5v-3h17v1c0 2.209139 1.790861 4 4 4h14c2.209139 0 4-1.790861 4-4v-1h17z" />
                                                                    <path id="Shape" d="m15 52h-2c-.5522847 0-1 .4477153-1 1s.4477153 1 1 1h2c.5522847 0 1-.4477153 1-1s-.4477153-1-1-1z" />
                                                                    <circle id="Oval" cx="5" cy="53" r="1" />
                                                                    <circle id="Oval" cx="9" cy="53" r="1" />
                                                                    <path id="Shape" d="m30 30c7.1797017 0 13-5.8202983 13-13 0-7.17970175-5.8202983-13-13-13s-13 5.82029825-13 13c.008266 7.1762751 5.8237249 12.991734 13 13zm0-24c6.0751322 0 11 4.9248678 11 11s-4.9248678 11-11 11-11-4.9248678-11-11c.0071635-6.0721626 4.9278374-10.9928365 11-11z" />
                                                                    <path id="Shape" d="m25.7 24.019c.1510172.6758719.6385372 1.2268337 1.291 1.459.9655907.3454686 1.9834689.5220496 3.009.522.7093957-.0007512 1.4163592-.0829563 2.107-.245 2.4813348-.5949487 4.5927859-2.2166431 5.8076453-4.4605466 1.2148595-2.2439034 1.4185843-4.8984494.5603547-7.3014534-.2308809-.6525752-.7807135-1.1408537-1.456-1.293-.6678543-.1529236-1.367337.0497373-1.85.536l-8.933 8.933c-.4854126.4831671-.6879357 1.1821742-.536 1.85zm10.9-9.352c.4529815 1.2787496.527288 2.6610594.214 3.981-.4622316 1.9319167-1.7262636 3.5750969-3.4750127 4.5173479s-3.816293 1.0941715-5.6839873.4176521z" />
                                                                    <path id="Shape" d="m23.423 21.35c.5285959-.0002743 1.035296-.2111595 1.408-.586l8.933-8.933c.4854126-.4831671.6879357-1.1821742.536-1.85-.1510172-.67587187-.6385372-1.22683366-1.291-1.459-3.2707615-1.16856777-6.9220918-.34781853-9.3781538 2.1080297-2.4560621 2.4558483-3.2771292 6.1071071-2.1088462 9.3779703.2876055.8027571 1.0472816 1.3393283 1.9 1.342zm-.231-6c.60786-2.5542076 2.6019103-4.5486446 5.156-5.157.5387455-.1273922 1.0903984-.1921543 1.644-.193.804837-.00046099 1.6036627.1385976 2.361.411l-8.948 8.92c-.453213-1.2787345-.527181-2.6612067-.213-3.981z" />
                                                                </g>
                                                            </g>
                                                        </svg>
                                                    </a>
                                            ...
                                            <?php if ($lessonData['sldetail_learner_status'] == ScheduledLesson::STATUS_ISSUE_REPORTED && $lessonData['issrep_id'] > 0) { ?>
                                                <li>
                                                    <a href="javascript:void(0);" onclick="issueDetails('<?php echo $lessonData['sldetail_id']; ?>')" class="" title="<?php echo Label::getLabel('LBL_Issue_Details'); ?>">
                                                        <svg version="1.1" width="35px" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 363 363" style="enable-background:new 0 0 363 363;" xml:space="preserve">
                                            ...
                                            <?php if ($lessonData['sldetail_learner_status'] == ScheduledLesson::STATUS_COMPLETED &&  $countReviews == 0) { ?>
                                                <li>
                                                    <a width="20px" href="javascript:void(0);" onclick="lessonFeedback('<?php echo $lessonData['sldetail_id'];  ?>');" class="" title="<?php echo Label::getLabel('LBL_Rate_Lesson'); ?>">
                                                        <svg enable-background="new 0 0 512 512" viewBox="0 0 512 512" width="30px" xmlns="http://www.w3.org/2000/svg">
                                                            <g>
                                            ...
                                            <?php if ($lessonData['sldetail_learner_status'] == ScheduledLesson::STATUS_NEED_SCHEDULING || $lessonData['sldetail_learner_status'] == ScheduledLesson::STATUS_SCHEDULED && $curDate < $startTime) { ?>
