	...
	<div class="screen">
		...
		<div class="screen__right">
			...
			<div class="tab-data-container">
                                                ...
                                                <div class="listing listing--vertical">
                                                    <ul>
                                                        ...
                                                        <li>
                                                            ...
                                                            ?>
                                                            <a href="javascript:void(0);" onclick="viewBookingCalendar('<?php echo $lessonData['sldetail_id']; ?>','<?php echo $is_trail; ?>')">
                                                                <?php echo Label::getLabel('LBL_Schedule'); ?>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="javascript:void(0);" onclick="cancelLesson('<?php echo $lessonData['sldetail_id']; ?>')" >
                ...
                ?>
                                                        <li>
                                                            <a href="javascript:void(0);" onclick="issueReported('<?php echo $lessonData['sldetail_id']; ?>')" >
                                                        ...
                                                        <?php if( $countReviews == 0 ){ ?>
                                                        <li>
                                                            <a href="javascript:void(0);" onclick="lessonFeedback('<?php echo $lessonData['sldetail_id'];  ?>');">
                                                        ...
                                                        <li>
                                                            <a href="javascript:void(0);" onclick="issueDetails('<?php echo $lessonData['sldetail_id']; ?>')" >
                                                        ...
                                                        <?php if($lessonData['sldetail_learner_status'] == ScheduledLesson::STATUS_SCHEDULED) { ?>
                                                        <li>
                                                            <a href="javascript:void(0);" onclick="requestReschedule('<?php echo $lessonData['sldetail_id']; ?>')">
                                                        ...
                                                        <?php } ?>
                                                        <?php
                $countRel=ScheduledLessonSearch::countPlansRelation($lessonData['sldetail_id']);
                if( $countRel > 0 ){
                ?>
                                                        <li>
                                                            <a href="javascript:void(0);" onclick="viewAssignedLessonPlan('<?php echo $lessonData['sldetail_id']; ?>')">
                                                                <?php echo Label::getLabel('LBL_View_Lesson_Plan'); ?>
                                                            </a>
                                                        </li>
