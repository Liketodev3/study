		...
		<div class="d-lg-flex align-items-center">
			...
			<div class="col-xl-4 col-lg-4 col-md-12 col-positioned">
				...
				<ul class="actions">
					...
					<?php if($lesson['slesson_status'] != ScheduledLesson::STATUS_CANCELLED AND $referer == preg_replace("(^https?://)", "", CommonHelper::generateFullUrl('LearnerScheduledLessons'))){ ?>
					...
					<?php if(($lesson['sldetail_learner_status'] == ScheduledLesson::STATUS_COMPLETED || ($lesson['sldetail_learner_status'] == ScheduledLesson::STATUS_SCHEDULED && $curDateTime>$endTime && $lesson['slesson_teacher_join_time']==0)) && ($lesson['issrep_id'] < 1 || $lesson['slesson_has_issue'] == applicationConstants::NO)) { ?>
                    <li>
					...
					<?php if(($lesson['sldetail_learner_status'] == ScheduledLesson::STATUS_NEED_SCHEDULING || $lesson['sldetail_learner_status'] == ScheduledLesson::STATUS_SCHEDULED) && $curDateTime<$startTime) { ?>
                    <li>
					...
					<?php } ?>
					<?php if( ScheduledLessonSearch::countPlansRelation($lesson['sldetail_id']) > 0 ){ ?>
					<li>
