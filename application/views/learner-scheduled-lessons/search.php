		...
		<div class="d-lg-flex align-items-center">
			...
			<div class="col-xl-4 col-lg-4 col-md-12 col-positioned">
				...
				<ul class="actions">
					...
					<?php } ?>
					<?php if($lesson['sldetail_learner_status'] == ScheduledLesson::STATUS_COMPLETED && ($lesson['issrep_id'] < 1 || $lesson['slesson_has_issue'] == applicationConstants::NO)) { ?>
						<li>
					...
					<?php } ?>
					<?php if($lesson['sldetail_learner_status'] == ScheduledLesson::STATUS_NEED_SCHEDULING || $lesson['sldetail_learner_status'] == ScheduledLesson::STATUS_SCHEDULED) { ?>
						<li>
