		...
		<div class="d-lg-flex align-items-center">
			...
			<div class="col-xl-4 col-lg-4 col-md-12 col-positioned">
				...
				<ul class="actions">
					...
					<?php if(($lesson['sldetail_learner_status'] == ScheduledLesson::STATUS_COMPLETED || ($lesson['sldetail_learner_status'] == ScheduledLesson::STATUS_SCHEDULED && $curDate>$endTime && $lesson['slesson_teacher_join_time']==0)) && ($lesson['issrep_id'] < 1 || $lesson['slesson_has_issue'] == applicationConstants::NO)) { ?>
                    <li>
