...
$preferenceTypeArr = Preference::getPreferenceTypeArr( CommonHelper::getLangId() );
?>
		...
		<div class="content-repeated-container">
			<?php if( $preferences ){
					foreach( $preferences as $preference ){
                        if(empty($preferenceTypeArr[$preference['preference_type']])){
                            continue;
                        }
						...
						<div class="content-repeated">
							<div class="row">
								<div class="col-xl-4 col-lg-4 col-sm-4">
									<p class="-small-title"><strong><?php echo $preferenceTypeArr[$preference['preference_type']]; ?></strong></p>
								</div>
