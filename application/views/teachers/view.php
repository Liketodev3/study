                            ...
                            <div class="profile-detail__body">
                                ...
                                <div class="detail-actions">
                                    <a href="javascript:void(0)" onClick="toggleTeacherFavorite(<?php echo $teacher['user_id']; ?>,this)" class="btn btn--bordered color-black">
                                        <svg class="icon icon--heart"><use xlink:href="<?php echo CONF_WEBROOT_URL.'images/sprite.yo-coach.svg#heart';?>"></use></svg>
                                        <?php echo Label::getLabel('LBL_Favorite'); ?>
                                    </a>
                                    <div class="toggle-dropdown">
                                        <a href="#" class="btn btn--bordered color-black toggle-dropdown__link-js">
                                            <svg class="icon icon--share"><use xlink:href="<?php echo CONF_WEBROOT_URL.'images/sprite.yo-coach.svg#share';?>"></use></svg>
                                    ...
                                    <div class="slider__item">
                                        <div class="card">
                                            <div class="card__head">
                                                <div class="card__title"><h4 class="color-primary"><?php echo $slabDetails['title']; ?></h4></div>
                                            </div>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        ...
                                                        <div class="timer">
                                                            <div class="timer__media">
                                                                <span> <svg class="icon icon--clock"><use xlink:href="<?php echo CONF_WEBROOT_URL.'images/sprite.yo-coach.svg#clock'; ?>"></use></svg></span>
                                                            </div>
                        ...
                        <div class="box box--book">
                            <div class="book__actions">
                                ...
                                <a href="#" class="btn btn--bordered btn--xlarge btn--block btn--contact color-primary">
                                    <svg class="icon icon--envelope"><use xlink:href="<?php echo CONF_WEBROOT_URL.'images/sprite.yo-coach.svg#envelope' ?>"></use></svg>
