				...
				<div class="row">
					...
					<div class="col-xl-9 col-lg-9 col-md-8 col-sm-8">
						<div class="box-list__head row justify-content-between">
							...
							<div class="col-auto">
								<a href="javascript:void(0)" onClick="toggleTeacherFavorite(<?php echo $teacher['user_id']; ?>, this)" class="btn btn--small btn--secondary-bordered btn--fav <?php echo($teacher['uft_id'])?'is-active':'';?>">
						...
						<div class="box-list__body">
							...
							<a href="javascript:void(0)" onClick="viewCalendar(<?php echo $teacher['user_id']?>,'paid');" class="btn btn--primary-bordered box__action-js">
								<span class="svg-icon">
								...
								<a href="javascript:void(0)" onClick="generateThread(<?php echo $teacher['user_id']; ?>)" class="btn btn--primary-bordered">
								<span class="svg-icon">
