...
<?php if ($teachers) { ?>
	<div class="result-container">
		...
		foreach ($teachers as $teacher) {
			$teacherUrl = CommonHelper::generateUrl('Teachers', 'view', [$teacher['user_url_name']]);
		?>
						...
						<div class="col-xl-9 col-lg-9 col-md-9 col-sm-8">
							...
							<div class="box-list__body">
								<div class="grid-group">
									...
									?>
									<!-- <div class="grid"><span><?php //echo Label::getLabel('LBL_Teaches'); 
																	?>: <strong><?php //echo CommonHelper::getTeachLangs($teacher['utl_slanguage_ids']); 
																				?></strong></span></div> -->
