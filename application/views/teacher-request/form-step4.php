            ...
            <div class="col-md-12 col-lg-10 col-xl-11">
                <div class="block-content">
                                ...
                                <div class="field-set margin-bottom-0 accept--field">
                                    <div class="field-wraper">
                                        <div class="field_cover">
                                            <label>
                                                <span class="checkbox"><?php echo $frm->getField('terms')->getHTML(); ?></span>
                    ...
                    <div class="block-content__foot">
                        <button type="button" class="btn btn--bordered color-primary btn-Back" onclick="getform(3);"><?php echo Label::getLabel('LBL_Back', $siteLangId); ?></button>
