...
$usrProfilePic = $frm->getField('user_profile_pic');
                                    ...
                                    <form class="form">
                                        <div class="img-upload">
                                            ...
                                            <div class="img-upload__content">
                                                <h6><?php echo $usrProfilePic->getCaption(); ?></h6>
                                                            ...
                                                            <?php foreach ($teachLangField->options as $key => $value) { ?>
                                                                <div class="selection">
                                                                    <label class="selection__trigger">
                                                                        <input name="<?php echo $teachLangField->getName(); ?>" value="<?php echo $key; ?>" class="selection__trigger-input" type="checkbox">
