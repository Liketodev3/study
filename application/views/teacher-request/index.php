        ...
        <div class="slideshow-content">
            ...
            <?php echo $applyTeachFrm->getFormTag(); ?>
                ...
                <div class="row justify-content-center">
                    <p><?php echo Label::getLabel('LBL_Apply_To_Teach_Aggreed',$siteLangId); ?></Label> ?><a href="<?php echo CommonHelper::generateUrl('cms','view',[2]) ?>" class="color-primary"><?php echo Label::getLabel('LBL_Terms_and_Conditions',$siteLangId) ?></a> <?php echo Label::getLabel('VLBL_and') ?> <a href="<?php echo CommonHelper::generateUrl('cms','view',[3]); ?>" class="color-primary"><?php echo Label::getLabel('LBL_Privacy_Policy',$siteLangId); ?></a></p>
                </div>
                <div class="row">
                    <div class="col-6">
                        <a href="javascript::void();" onclick="dofacebookInLoginForBuyerpopup();" class="btn btn--block social-button social-button--center social-button--fb-white ">
                    ...
                    <div class="col-6">
                        <a href="<?php echo CommonHelper::generateUrl('GuestUser', 'socialMediaLogin',array('google', $userType)); ?>" class="btn btn--block social-button social-button--center social-button--google-white ">
                            <span class="social-button__media">
