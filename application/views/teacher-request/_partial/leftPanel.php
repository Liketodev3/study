    ...
    <nav class="steps steps--vertical">
        <ul>
            <li class="steps__item <?php echo ($step == 1) ? 'is-process' : ''; ?>" data-blocks-show="1">
                <a href="javascript:void(0);" <?php echo ($step >= 1) ? 'onclick="getform(1);"' : ''; ?>>
