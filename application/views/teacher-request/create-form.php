...
switch ($formStep) {
    case 1:
        ...
        $usrPhoneCode->setFieldTagAttribute('id', 'user_phone_code');
        $usrPhone = $frm->getField('utrvalue_user_phone');
        $usrPhone->setFieldTagAttribute('id', 'user_phone');
        $usrPhotoId = $frm->getField('user_photo_id');
        break;
    case 2:
        $usrVideoLink = $frm->getField('utrvalue_user_video_link');
        $usrBio = $frm->getField('utrvalue_user_profile_info');
        break;
    case 3:
        $teachLangField = $frm->getField('utrvalue_user_teach_slanguage_id[]');
        $speakLangField = $frm->getField('utrvalue_user_language_speak[]');
        $proficiencyField = $frm->getField('utrvalue_user_language_speak_proficiency[]');
        break;
    case 4:
        $terms = $frm->getField('terms');
                        ...
                        <form class="form">
                            <div class="img-upload">
                                <div class="img-upload__media">
                                    <div class="avtar avtar--large" data-title="<?php echo CommonHelper::getFirstChar($userDetails['user_first_name']); ?>">
                                ...
                                <div class="img-upload__content">
                                    ...
                                    <a href="javascript:void()" id="uploadFileInput--js" class="btn btn--bordered btn--small color-secondary"><?php echo Label::getLabel('LBL_Upload', $siteLangId); ?></a>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="colum-layout__cell">
                                        ...
                                        <div class="colum-layout__body">
                                            <div class="colum-layout__scroll scrollbar scrollbar-js" tabindex="0" style="width: 431px; padding-right: 10px; outline: none; overflow: hidden;">
                                                ...
                                                $dataFatreq = $teachLangField->requirements()->getRequirementsArray();
                                                $dataFatreq = FatUtility::convertToJson($dataFatreq, JSON_HEX_QUOT);

                                                foreach ($teachLangField->options as $key => $value) { ?>
                                                    <div class="selection">
                                                        <label class="selection__trigger">
                                                            <input <?php echo (reset($teachLangField->options) == $value) ? "data-fatreq='".$dataFatreq."'" : ''; ?> name="<?php echo $teachLangField->getName(); ?>" value="<?php echo $key; ?>" class="selection__trigger-input" type="checkbox">
                ...
                <div class="block-content">
                    ...
                    <?php if (count($rows) > 0) { ?>
                        <div class="info__action">
                            <a href="javascript:void(0)" onclick="teacherQualificationForm(0);" class="btn btn--bordered btn--small color-secondary">Add Resume</a>
                        </div>
                                    ...
                                    <div class="field-set margin-bottom-0 accept--field">
                                        <div class="field-wraper">
                                            <div class="field_cover">
                                                <label>
                                                    <span class="checkbox">
                                                        <?php echo $terms->getHTML(); ?>
                                                    </span>
                                                    <a href="<?php echo CommonHelper::generateUrl('cms', 'view', [2]) ?>"><?php echo Label::getLabel('LBL_Terms_and_Conditions', $siteLangId); ?></a>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
