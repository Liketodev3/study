					...
					<div class="box__profile-head">
						<div class="row align-items-center">
							...
							<div class="col-xl-6 col-lg-6 col-md-8 col-sm-8">
								<h3 class="-display-inline"><a href="<?php echo CommonHelper::generateUrl('teachers','view',array($teacher['user_id'])); ?>"><?php echo $teacher['user_full_name']; ?></a></h3>
							...
							<div class="col-xl-3 col-lg-3 col-md-8 col-sm-12 offset-min-12">
								...
								<a href="<?php echo CommonHelper::generateUrl('teachers','view',array($teacher['user_id'])); ?>" class="btn btn--secondary btn--large btn--block"><?php echo Label::getLabel('LBL_View_Profile'); ?></a>
							</div>
							<!-- ] -->
