        ...
        <table class="table">
			...
			{ 
				echo CommonHelper::displayNotApplicable('');
                    ...
                    <td width="20%">
                        <a class="btn btn--secondary btn--small" href="javascript:void(0);" onclick="add('<?php echo $lessonPlanData['tlpn_id'];  ?>');">Edit</a>
                        <a class="btn btn--small" href="javascript:void(0);" onclick="removeLesson('<?php echo $lessonPlanData['tlpn_id'];  ?>');">Delete</a>
                    </td>
