                ...
                <?php foreach($topRatedTeachers as $topRatedTeacher){ ?> 
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="border-box">
                            <span class="box-pic">
                                <a href="<?php echo CommonHelper::generateUrl('Teachers', 'profile').'/'. $topRatedTeacher['user_url_name'];?>"><img src="<?php echo CommonHelper::generateUrl('Image','User', array( $topRatedTeacher['user_id'] )) ?>"></a></span>
                            <div class="box-body">
