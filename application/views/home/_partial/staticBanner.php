                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                        <div class="tile">
                            ...
                            <div class="tile__body">
                                <a class="tile__title" href="<?php echo CommonHelper::generateUrl('Teachers', 'profile') . '/' . $topRatedTeacher['user_url_name']; ?>"><h4><?php echo $topRatedTeacher['user_first_name'] . ' ' . $topRatedTeacher['user_last_name']; ?></h4></a>
                                <div class="tile__detail">
                                    ...
                                    <div class="info-tag tile__ratings ratings">
                                        ...
                                        <span class="ratings__value"><?php echo $topRatedTeacher['teacher_rating']; ?></span>
                                        <!-- <span class="ratings__count">(185)</span> -->
                                    </div>
                                </div>
                                <div class="card__row--action ">
                                    <a href="<?php echo CommonHelper::generateUrl('Teachers', 'profile') . '/' . $topRatedTeacher['user_url_name']; ?>" class="btn btn--primary btn--block">View Profile</a>
                                </div>
                            </div>
