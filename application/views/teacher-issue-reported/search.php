		...
		<div class="d-lg-flex align-items-center">
			<div class="col-xl-4 col-lg-4 col-md-12">
				<div class="avtar avtar--normal" data-text="<?php echo CommonHelper::getFirstChar($_issue['user_first_name']); ?>">
					<?php
					if( true == User::isProfilePicUploaded( $_issue['sldetail_learner_id'] ) ){
						$img = CommonHelper::generateUrl('Image','user', array( $_issue['sldetail_learner_id'] )).'?'.time();
						echo '<img src="'.$img.'" />';
					} ?>
				</div>
					...
					<div class="select-box__target -skin toggle__target-js" style="display: none;">
						<div class="listing listing--vertical">
							...
							<?php if( $_issue['issrep_status'] == 0 ) { ?>
								<li>
									<a href="javascript:void(0);" onclick="resolveIssue('<?php echo $_issue['slesson_id']; ?>', '<?php echo $_issue['issrep_id']; ?>')"><?php echo Label::getLabel('LBL_Resolve_Issue'); ?></a>
								</li>
							<?php } ?>
