	...
	$(document).ready(function() {
		...
		$('#d_calendar').fullCalendar({
			...
			select: function (start, end, jsEvent, view ) {
				...
				newEvent.lessonDetailId = '<?php echo $lessonDetailId; ?>';
