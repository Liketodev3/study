                ...
                <div class="header__actionList -display-inline">
                    <nav class="nav nav--primary nav--actions -display-inline">
                        <ul>
							...
							?>
                            <li>
                                <a href="<?php echo CommonHelper::generateUrl('Messages','', [], CONF_WEBROOT_DASHBOARD); ?>" class="nav__dropdown-action nav__dropdown-msg">
                            ...
                            <li class="nav__dropdown nav__dropdown--notification">
                                <a href="<?php echo CommonHelper::generateUrl('Notifications', '', [], CONF_WEBROOT_DASHBOARD); ?>" class="nav__dropdown-action nav__dropdown-msg nav__dropdown-trigger-js">
                                ...
                                <div class="nav__dropdown-target nav__dropdown-target-js -skin">
                                    ...
                                    <div class="list-container">
                                        ...
                                        <div class="list-container__body">
                                            <div class="list-group">
                                                ...
                                                <div class="list">
                                                    ...
                                                    <a href="<?php echo CommonHelper::generateUrl('notifications','readNotification',array($notifications['noti_id']), CONF_WEBROOT_DASHBOARD); ?>" class="list__action"></a>
                                                </div>
                                                <?php } ?>
                                            </div>
                                        ...
                                        <div class="list-container__footer">
                                            <a href="<?php echo CommonHelper::generateUrl('Notifications','', [], CONF_WEBROOT_DASHBOARD); ?>" class="btn btn--secondary btn--block"><?php echo Label::getLabel("LBL_View_all"); ?></a>
                                        </div>
                                    </div>
                                </div>
                                <?php } ?>
