	 ...
	 <table class="table">
		...
		<tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="td__data"><?php echo $order['learner_name']; ?></span>
                                    </td>
                                    <td>
                                        <span class="td__caption -hide-desktop -show-mobile"><?php echo CommonHelper::displayMoneyFormat(Label::getLabel('LBL_Order_Amount')); ?></span>
                                        <span class="td__data"><?php echo $order['order_net_amount']; ?></span>
                                    </td>
                                    <td>
                                    ...
                                    <td>
										...
										<span class="td__data">
										<?php echo MyDate::convertTimeFromSystemToUserTimezone( 'Y-m-d H:i:s', $order['order_date_added'], true , $user_timezone ); ?>
										</span>
                                    </td>									
                                    <td>
                                        ...
                                        <span class="td__data">
                                            ...
                                            <a href="javascript:void(0)" onClick="generateThread(<?php echo $order['order_user_id']; ?>)"  class="btn btn--small btn--secondary"><?php echo Label::getLabel('LBL_Message'); ?></a>                                            
                                        </span>
                                    </td>
                                </tr>
		<?php $i++; } ?>
