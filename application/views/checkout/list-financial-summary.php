...
<div class="table-total">
	<table>
		...
		<tr>
			<td>
				<h6><strong><?php echo Label::getLabel('LBL_Fee/Commission'); ?></strong></h6></td>
			<td>
				<h6 class="-color-secondary"><?php echo CommonHelper::displayMoneyFormat($cart['siteCommission']); ?></h6></td>
		</tr>
		<?php } ?>
		...
		<tr>
			<td>
				<h6><strong><?php echo Label::getLabel('LBL_Coupon_Discount'); ?></strong></h6></td>
			<td>
				<h6 class="-color-secondary"><?php echo '-'.CommonHelper::displayMoneyFormat($cart['cartDiscounts']['coupon_discount_total']); ?></h6></td>
		</tr>
		<?php } ?>
		<?php 
			$wallet = 0; 
		...
		<tr>
			<td>
				<h6><strong><?php echo Label::getLabel('LBL_Wallet_Deduction'); ?></strong></h6></td>
			<td>
				<h6 class="-color-secondary"><?php echo '-'.CommonHelper::displayMoneyFormat($userWalletBalance); ?></h6></td>
		</tr>
		<?php } if($wallet > $cart['orderNetAmount']){
			$cart['orderNetAmount']  = $wallet;
		} ?>
		<tr class="last">
			<td>
				<h6><strong><?php echo Label::getLabel('LBL_Total'); ?></strong></h6></td>
			<td>
				<h6 class="-color-secondary"><?php echo CommonHelper::displayMoneyFormat($cart['orderNetAmount']-$wallet); ?></h6></td>
		</tr>
	</table>
</div>
