					<div class="box -padding-20" style="margin-bottom:30px;">
						...
						<div class="selection-list">
							<ul>
								...
								if(isset($teachcerOffer['top_single_lesson_price']) && isset($teachcerOffer['top_bulk_lesson_price'])) {
									$bulkLessonAmount =  $teachcerOffer['top_bulk_lesson_price'];
									$singleLessonAmount =  $teachcerOffer['top_single_lesson_price'];
								}
