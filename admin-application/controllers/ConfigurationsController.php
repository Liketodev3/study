...
class ConfigurationsController extends AdminBaseController {
	...
	public function uploadMedia(){
		...
		if(!$res = $fileHandlerObj->saveAttachment($_FILES['file']['tmp_name'], $file_type, 0, 0,
		$_FILES['file']['name'], -1, $unique_record = true, $lang_id)
		){
	...
	private function getForm( $type , $arrValues = array() ){
		...
		switch( $type ){
			...
			case Configurations::FORM_LOCAL:				
				$frm->addSelectBox(Label::getLabel('LBL_Default_Site_Laguage',$this->adminLangId),'CONF_DEFAULT_SITE_LANG',
				Language::getAllNames(),false,array(),'');
			...
			case Configurations::FORM_REVIEWS:
				...
				$fld =$frm->addSelectBox(Label::getLabel("LBL_Default_Review_Status",$this->adminLangId),'CONF_DEFAULT_REVIEW_STATUS',
				$reviewStatusArr,false,array(),'');
			...
			case Configurations::FORM_OPTIONS:
				...
				$fld5 = $frm->addCheckBox(Label::getLabel("LBL_Activate_Admin_Approval_After_Registration_(Sign_Up)",$this->adminLangId),
				...
				$fld7 = $frm->addCheckBox(Label::getLabel("LBL_Activate_Email_Verification_After_Registration",$this->adminLangId)
				,'CONF_EMAIL_VERIFICATION_REGISTRATION',1,array(),false,0);
				...
				$fld9 = $frm->addCheckBox(Label::getLabel("LBL_Activate_Auto_Login_After_Registration",$this->adminLangId),'CONF_AUTO_LOGIN_REGISTRATION',
				1,array(),false,0);
				...
				$fld10 = $frm->addCheckBox(Label::getLabel("LBL_Activate_Sending_Welcome_Mail_After_Registration",$this->adminLangId),
				'CONF_WELCOME_EMAIL_REGISTRATION',1,array(),false,0);
				...
				$fld = $frm->addSelectBox(Label::getLabel("LBL_Default_Child_Order_Status",$this->adminLangId),'CONF_DEFAULT_ORDER_STATUS',
				$orderStatusArr,false,array(),'');
				
				$fld = $frm->addSelectBox(Label::getLabel("LBL_Default_Child_Paid_Order_Status",$this->adminLangId),'CONF_DEFAULT_PAID_ORDER_STATUS',
				$orderStatusArr,false,array(),'');
			...
			case Configurations::FORM_LIVE_CHAT:
				$fld = $frm->addRadioButtons(Label::getLabel("LBL_Activate_Live_Chat",$this->adminLangId),'CONF_ENABLE_LIVECHAT',
