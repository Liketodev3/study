...
class LanguagesController extends AdminBaseController {
	...
	public function setup(){
		...
		$this->set('msg', Label::getLabel('LBL_Keyword',$this->adminLangId));
	...
	private function getForm($languageId = 0){	
		...
		$fld =$frm->addRadioButtons(Label::getLabel("LBL_Language_Layout_Direction",$this->adminLangId),'language_layout_direction',
		...
		$fld =$frm->addRadioButtons(Label::getLabel("LBL_Language_Flag",$this->adminLangId),'language_flag',
				$arrFlag,'',array('class'=>'list-inline')); */
		$activeInactiveArr = applicationConstants::getActiveInactiveArr($this->adminLangId);
		$frm->addSelectBox(Label::getLabel('LBL_Status',$this->adminLangId), 'language_active',$activeInactiveArr,'',array(),'');										
