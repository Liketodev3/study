...
class TwocheckoutSettingsController extends PaymentSettingsController{
	...
	private function getForm() {		
		...
		$frm->addRadioButtons(Label::getLabel('LBL_Payment_Type',$this->adminLangId), 'payment_type', $paymentTypesArr, 'HOSTED',array('class'=>'box--scroller'));
		...
		$frm->addHTML('Remember', '&nbsp;', 'In case of <strong>Hosted Checkout</strong>, Admin must set <strong>Direct Return (URL)</strong> to <strong>Header Redirect</strong> and 
