...
class AdminUsersController extends AdminBaseController
{
    ...
    public function changeStatus()
    {
        ...
        $data = AdminUsers::getAttributesById($adminId, array(
            'admin_id',
            'admin_active'
        ));
        if ($data == false) {
    ...
    public function roles()
    {
        ...
        /* $permissionModules = array(0 => Label::getLabel('MSG_All_Modules',$this->adminLangId)) + $permissionModules; */
    ...
    private function getForm($adminId = 0)
    {
        ...
        $frm->addSelectBox(Label::getLabel('LBL_Status', $this->adminLangId), 'admin_active', $activeInactiveArr, '', array(), '');
    ...
    private function getAllAccessForm()
    {
        ...
        $fld = $frm->addSelectBox(Label::getLabel('LBL_Select_permission_for_all_modules', $this->adminLangId), 'permissionForAll', $permissionArr, '', array(
            'class' => 'permissionForAll'
        ), Label::getLabel('LBL_Select', $this->adminLangId));
        $fld->requirements()->setRequired();
        $frm->addSubmitButton('', 'btn_submit', Label::getLabel('LBL_Apply_to_All', $this->adminLangId), array(
            'onclick' => 'updatePermission(0);return false;'
        ));
        return $frm;
    }
