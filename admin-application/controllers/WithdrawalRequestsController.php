...
class WithdrawalRequestsController extends AdminBaseController {
	...
	public function updateStatus(){
		...
		if(!FatApp::getDb()->updateFromArray(User::DB_TBL_USR_WITHDRAWAL_REQ,$assignFields,
        ...
        $rs = FatApp::getDb()->updateFromArray(Transaction::DB_TBL,array("utxn_status"=>Transaction::STATUS_COMPLETED), 
