...
class BlogCommentsController extends AdminBaseController
{
    ...
    private function getForm($bpcomment_id = 0)
    {
        ...
        $statusArr = applicationConstants::getBlogCommentStatusArr($this->adminLangId);
        $frm->addSelectBox(Label::getLabel('LBL_Comment_Status', $this->adminLangId), 'bpcomment_approved', $statusArr, '', array('class'=>'small'), '');
    ...
    private function getSearchForm()
    {
        ...
        $statusArr = applicationConstants::getBlogCommentStatusArr($this->adminLangId);
        $frm->addSelectBox(Label::getLabel('LBL_Comment_Status', $this->adminLangId), 'bpcomment_approved', $statusArr, '', array('class'=>'small'), 'Select');
