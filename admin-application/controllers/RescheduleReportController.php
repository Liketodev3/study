...
class RescheduleReportController extends AdminBaseController
{
    ...
    public function __construct($action)
    {
        ...
        $this->canEdit = $this->objPrivilege->canEditRescheduleReport($this->admin_id, true);
    ...
    public function search()
    {
        ...
        //$srch->addOrder('teacherCancelledLessons', 'DESC');
    ...
    { 
        ...
        $arr = array(
                    ...
                    Label::getLabel('Originally scheduled date', $this->adminLangId),
                    Label::getLabel('Current Lesson Status', $this->adminLangId)
                );
