			...
			case 'action':
				...
				if($canEdit){					
					...
					if( $row['child_count'] > 0){
						...
						$li->appendElement('a', array('href'=>"javascript:void(0)", 'class'=>'button small green', 'title'=>Label::getLabel('LBL_Content_Block',$adminLangId),"onclick"=>"contentBlock(".$row['bpcategory_id'].")"),'<i class="ion-grid icon"></i>', true); */
					}
