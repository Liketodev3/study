...
<!--<div class="row">
	<div class="col-sm-12"> -->
		<h1><?php // echo Label::getLabel('LBL_Manage_Coupons',$adminLangId); ?> </h1>
			...
			<section class="section">
				<div class="sectionhead">
					...
					<?php if($canEdit){ 
						...
						/*
					<a href="javascript:void(0)" class="themebtn btn-default btn-sm" onClick="addCouponForm(0)";><?php echo Label::getLabel('LBL_Add_New_Coupon',$adminLangId); ?></a>*/
					 } ?>
				</div>
