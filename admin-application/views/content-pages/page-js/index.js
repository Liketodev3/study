			...
			$.ajax({
				...
				success: function(ans) {
						...
						*/
						...
						$(".uploaded--image").html('<img src="'+fcom.makeUrl('ContentPages', 'cpageBackgroundImage', [ans.cpage_id,ans.lang_id,'THUMB'])+'?'+time+'"> <a href="javascript:void(0);" onclick="removeBgImage('+[ans.cpage_id,ans.lang_id,ans.cpage_layout]+')" class="remove--img"><i class="ion-close-round"></i></a>');
						fcom.displaySuccessMessage(ans.msg);
					},
