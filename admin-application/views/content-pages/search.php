	...
	foreach ($arr_flds as $key=>$val){
		...
		switch ($key){
			...
			case 'action':
				...
				$li->appendElement('a', array('href'=>CommonHelper::generateFullUrl( "Cms", "View", array($row['cpage_id'] ), CONF_WEBROOT_FRONT_URL ), 'class'=>'button small green', 'title'=>Label::getLabel('LBL_Preview',$adminLangId), 'target' => '_blank'),'<i class="ion-clipboard icon"></i>', true); */
			break;
			default:
				$td->appendElement('plaintext', array(), $row[$key],true);
			break;
