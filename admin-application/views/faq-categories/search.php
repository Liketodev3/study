        ...
        switch ($key) {
            ...
            case 'action':
                ...
                /*if ($canViewFaq) {
                    ...
                    $innerLiFaqListing->appendElement('a', array('href'=>'javascript:void(0)','onclick'=>'redirectUrl("'.$url.'")', 'class'=>'button small green', 'title'=>Label::getLabel('LBL_FAQ_Listing', $adminLangId)), Label::getLabel('LBL_FAQ_Listing', $adminLangId), true);
                } */
