	...
	<div class="tabs_nav_container responsive flat">
		<ul class="tabs_nav">
			...
			foreach($languages as $langId=>$langName){ ?>
				<li class="<?php echo $inactive;?>"><a href="javascript:void(0);" <?php if($optId>0){?> onclick="editOptionLangForm(<?php echo $optId ?>, <?php echo $langId;?>);" <?php }?>><?php echo Label::getLabel('LBL_'.$langName,$adminLangId);?></a></li>
			<?php } ?>
		</ul>
