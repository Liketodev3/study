...
$htmlAfterField = '<div style="margin-top:15px;" class="preferredDimensions-js">'. sprintf(Label::getLabel('LBL_Preferred_Dimensions_%s',$adminLangId),'1920 x 550').'</div>';
...
<section class="section">
	...
	<div class="sectionbody space">
		<div class="row">	
			...
			<div class="col-sm-12">
				<h1><?php //echo Label::getLabel('LBL_Slide_Image_Setup',$adminLangId); ?></h1>
...
<script>
	$(document).on('change','.prefDimensions-js',function(){
		...
		{
			$('.preferredDimensions-js').html((langLbl.preferredDimensions).replace(/%s/g, '1920 x 550'));
		}
