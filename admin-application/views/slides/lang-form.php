		...
		<ul class="tabs_nav">
			...
			if ($slide_id > 0) {
				foreach($languages as $langId => $langName){?>
					<li><a class="<?php echo ($slide_lang_id == $langId)?'active':''?>" href="javascript:void(0);" onclick="slideLangForm(<?php echo $slide_id ?>, <?php echo $langId;?>);"><?php echo  Label::getLabel('LBL_'.$langName,$adminLangId);?></a></li>
				<?php }
				}
			?>
