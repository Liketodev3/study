...
?>
	...
	<aside class="leftside">
		...
		<!--Dashboard-->
		<?php if(
			$objPrivilege->canViewAdminDashboard($adminLoggedId, true)
		){ ?>
		<li><a href="<?php echo CommonHelper::generateUrl();?>"><?php echo Label::getLabel('LBL_Dashboard',$adminLangId);?></a></li>
		<?php } ?>

		<?php if(
			$objPrivilege->canViewUsers( $adminLoggedId, true ) || $objPrivilege->canViewTeacherApprovalRequests($adminLoggedId, true) || $objPrivilege->canViewWithdrawRequests($adminLoggedId, true) || $objPrivilege->canViewTeacherReviews($adminLoggedId, true)
		){ ?>
		...
		<?php if( $objPrivilege->canViewPurchasedLessons($adminLoggedId, true) || $objPrivilege->canViewIssuesReported($adminLoggedId, true) || $objPrivilege->canViewGiftcards($adminLoggedId, true)){ ?>
		...
		<li class="haschild"><a href="javascript:void(0);"><?php echo Label::getLabel('LBL_Teacher_Preferences',$adminLangId);?></a>
			<ul>
				...
				if ($objPrivilege->canViewTeachingLanguage($adminLoggedId, true)) { ?>
		...
		<?php if(
			...
			//$objPrivilege->canViewCourseCategory($adminLoggedId, true) ||
		...
		<li class="haschild"><a href="javascript:void(0);"><?php echo Label::getLabel('LBL_Cms',$adminLangId);?></a>
			<ul>
				...
				<?php if($objPrivilege->canViewLessonPackages($adminLoggedId, true)){?>
		...
		<?php if(
            ...
            //|| $objPrivilege->canViewEmailArchives($adminLoggedId, true)
			){ ?>
		<li class="haschild"><a href="javascript:void(0);"><?php echo Label::getLabel('LBL_Misc',$adminLangId);?></a>
			<ul>
				...
				<?php /* if($objPrivilege->canViewEmailArchives($adminLoggedId, true)){?>
		...
		<li class="haschild">
			...
			<?php } ?>
			<?php
			if ( $objPrivilege->canViewCommissionReport($adminLoggedId, true) ) { ?>
