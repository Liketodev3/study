...
<aside class="leftside">
    <div class="sidebar_inner">
        ...
        <ul class="leftmenu">
            <!--Dashboard-->
            <?php
            if ($objPrivilege->canViewAdminDashboard(AdminAuthentication::getLoggedAdminId(), true)) {
                ?>
            ...
            if (
                    ...
                    $objPrivilege->canViewTeacherApprovalRequests(AdminAuthentication::getLoggedAdminId(), true) ||
                    $objPrivilege->canViewWithdrawRequests(AdminAuthentication::getLoggedAdminId(), true) ||
                    $objPrivilege->canViewTeacherReviews(AdminAuthentication::getLoggedAdminId(), true)
            ) {
                ?>
            ...
            <?php if ($objPrivilege->canViewPreferences(AdminAuthentication::getLoggedAdminId(), true)) { ?>
                <li class="haschild"><a href="javascript:void(0);"><?php echo Label::getLabel('LBL_Teacher_Preferences', $adminLangId); ?></a>
                    <ul>
                        ...
                        <?php } ?>
                        <?php if ($objPrivilege->canViewTeachingLanguage(AdminAuthentication::getLoggedAdminId(), true)) { ?>
