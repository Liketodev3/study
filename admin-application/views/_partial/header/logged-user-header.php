            ...
            <div class="one_third_grid">
                <ul class="iconmenus">
					...
					/* <li class="togglemsg droplink">
                        ...
                        <div class="dropwrap">
                            <div class="head"><?php echo Label::getLabel('LBL_Notifications',$adminLangId);?></div>
                            <div class="body" id="notificationList">

                            </div>
							<div class="foot"><a href="<?php echo CommonHelper::generateUrl('notifications','');?>" class="link redirect--js"><?php echo Label::getLabel('LBL_View_all',$adminLangId); ?></a></div>
                        </div>
                    </li> */
					?>
					...
					<?php 
					/* <li class="sitemap">
                        <a title="<?php echo Label::getLabel('LBL_Update_Sitemap',$adminLangId);?>" href="<?php echo CommonHelper::generateUrl('sitemap', 'generate'); ?>"><img src="<?php echo CONF_WEBROOT_URL; ?>images/sitemap.svg" width="20" alt=""></a>
                    </li> */
					?>
