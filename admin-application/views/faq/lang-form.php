...
$langFrm->setFormTagAttribute('onsubmit', 'setupLangFaq(this); return(false);');
		...
		<ul class="tabs_nav">
			...
			if ($faqId > 0) {
				foreach($languages as $langId=>$langName){?>
					<li><a class="<?php echo ($lang_id == $langId)?'active':''?>" href="javascript:void(0);" onclick="editFaqLangForm(<?php echo $faqId ?>, <?php echo $langId;?>);"><?php echo Label::getLabel('LBL_'.$langName,$adminLangId);?></a></li>
				<?php }
				}
			?>
