...
switch(strtoupper($stats_type)){
	case 'TOP_COUNTRIES':
		if($stats_info['totalsForAllResults']==0){ echo "<li>".Label::getLabel('LBL_No_Record_Found',$adminLangId)."</li>"; exit;}
	...
	case 'TOP_LESSON_LANGUAGES':
		if(count($stats_info)==0){echo "<li>".Label::getLabel('LBL_No_Record_Found',$adminLangId)."</li>"; exit;}
		$count=1;
