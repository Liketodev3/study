			...
			<div class="col-sm-12">
				...
				<div class="tabs_nav_container responsive flat">
					<ul class="tabs_nav">
						...
						<li class="<?php echo $inactive;?>"><a href="javascript:void(0);" <?php if($state_id>0){?> onclick="editStateLangForm(<?php echo $state_id ?>, <?php echo $langId;?>);" <?php }?>><?php echo Label::getLabel('LBL_'.$langName,$adminLangId);?></a></li>
						<?php } ?>
					</ul>
